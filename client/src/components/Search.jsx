...
import { suggestions } from "../data/constant"; // Import the suggestions data
...
const Search = () => {
  ...
  const [date, setDate] = useState([
    {
      startDate: new Date("2022-01-01"), // Set the start date to January 1, 2022.
      endDate: new Date("2022-12-31"),   // Set the end date to December 31, 2022.
      key: "selection",
    },
  ]);

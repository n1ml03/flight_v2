...
import { flight } from "../assets/logo";
       ...
       {toggle ? (
        ...
        { toggle && (
            <ul className="absolute w-32 z-10 h-fit bg-[#FFFFFF] shadow-xl top-14 left-0 text-[#7C8DB0] flex flex-col gap-2 items-start p-4 scaleUp">
                <Link
              to="/"
              className={`text-base  hover:text-[#605DEC] transition-all duration-200 ${locationPath("/") && "text-[#605DEC]"}`}
            >
              <li>Flights</li>
            </Link>
            <Link
              to="/hotels"
              className={`text-base hover:text-[#605DEC] transition-all duration-200 ${locationPath("/hotels") && "text-[#605DEC]"}`}
            >
              <li>Hotels</li>
            </Link>
            <Link
              to="/packages"
              className={`text-base hover:text-[#605DEC] transition-all duration-200 ${locationPath("/packages") && "text-[#605DEC]"}`}
            >
              <li>Packages</li>
            </Link>
            </ul>
